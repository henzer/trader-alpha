import { getAllLists, getLatestStocks, getTotalStocksCount } from '@/lib/supabase'
...
export default async function ListsPage() {
  const [lists, stocks, totalCount] = await Promise.all([
    getAllLists(),
    getLatestStocks(100),
    getTotalStocksCount()
  ])
  ...
  return (
    <div>
      ...
      <InfiniteStockList initialStocks={stocks} />
    </div>
  )
}
